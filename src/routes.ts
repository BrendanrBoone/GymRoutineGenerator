...
export type IGenerateScreenProps = StackScreenProps<RootStackParamList, typeof route_names.GENERATE_SCREEN>;
export type IAddExerciseScreenProps = StackScreenProps<RootStackParamList, typeof route_names.ADD_EXERCISE_SCREEN>;
export type ISignOutScreenProps = StackScreenProps<RootStackParamList, typeof route_names.SIGN_OUT_SCREEN>;
